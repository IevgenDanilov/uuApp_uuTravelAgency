...
const RouteBar = createVisualComponent({
  ...
  render(props) {
    ...
    const appActionList = [
      ...
      { children: <Lsi lsi={LSI.menu.trips} />, onClick: () => setRoute("trips") },
      { children: <Lsi lsi={LSI.menu.participants} />, onClick: () => setRoute("participants") },
      { children: <Lsi lsi={LSI.menu.locations} />, onClick: () => setRoute("locations") },
