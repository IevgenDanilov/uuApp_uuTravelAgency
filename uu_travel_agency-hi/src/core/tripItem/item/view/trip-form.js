  ...
  render(props) {
    ...
    function _handleOnSave(opt) {
      ...
      if (props.onSave) {
        ...
        props.onUpdate({ id: props.values.id, ...values });
      }
    }
    ...
    return (
      <div {...attrs}>
        <UU5.Forms.Form onSave={_handleOnSave} onCancel={props.modalRef.current.close} values={props.values || null}>
          ...
          />
          <UU5.Forms.Text placeholder="1000" name="price" label={useLsi(Lsi.price)} />
          <UU5.Forms.Text placeholder="30" name="maxCapacity" label={useLsi(Lsi.maxCapacity)} />
          <UU5.Forms.Radios
            name="state"
            required
