function insert(styleEl) {
  ...
  styleEl.setAttribute("data-owner", "uu_travel_agency-hi/uu_travel_agency-hi@0.1.0");
  styleEl.setAttribute("data-emotion", "uutravelagency");
  styleEl.setAttribute("data-tech", "less");

  // insert the style element
  // 1. after last matching data-emotion using technology "less"
  let els = insertionEl.querySelectorAll(`style[data-emotion="uutravelagency"]`);
