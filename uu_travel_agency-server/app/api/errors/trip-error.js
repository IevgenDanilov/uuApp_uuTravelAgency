...
const AddParticipant = {
  UC_CODE: `${TravelAgencyUseCaseError.ERROR_PREFIX}trip/addParticipant/`,

  InvalidDtoIn: class extends TravelAgencyUseCaseError {
    constructor() {
      super(...arguments);
      this.code = `${AddParticipant.UC_CODE}invalidDtoIn`;
      this.message = "DtoIn is not valid.";
    }
  },
  TravelAgencyDoesNotExist: class extends TravelAgencyUseCaseError {
    constructor() {
      super(...arguments);
      this.code = `${AddParticipant.UC_CODE}travelAgencyDoesNotExist`;
      this.message = "TravelAgency does not exist.";
    }
  },
  TravelAgencyNotInCorrectState: class extends TravelAgencyUseCaseError {
    constructor() {
      super(...arguments);
      this.code = `${AddParticipant.UC_CODE}travelAgencyNotInCorrectState`;
      this.message = "TravelAgency is not in correct state.";
    }
  },
  TripDoesNotExist: class extends TravelAgencyUseCaseError {
    constructor() {
      super(...arguments);
      this.code = `${AddParticipant.UC_CODE}tripDoesNotExist`;
      this.message = "Trip does not exist.";
    }
  },

  TripDaoAddParticipantFailed: class extends TravelAgencyUseCaseError {
    constructor() {
      super(...arguments);
      this.code = `${AddParticipant.UC_CODE}tripDaoAddParticipantFailed`;
      this.message = "Add participant in trip failed.";
    }
  },
};

const RemoveParticipant = {
  UC_CODE: `${TravelAgencyUseCaseError.ERROR_PREFIX}trip/removeParticipant/`,

  InvalidDtoIn: class extends TravelAgencyUseCaseError {
    constructor() {
      super(...arguments);
      this.code = `${RemoveParticipant.UC_CODE}invalidDtoIn`;
      this.message = "DtoIn is not valid.";
    }
  },
  TravelAgencyDoesNotExist: class extends TravelAgencyUseCaseError {
    constructor() {
      super(...arguments);
      this.code = `${RemoveParticipant.UC_CODE}travelAgencyDoesNotExist`;
      this.message = "TravelAgency does not exist.";
    }
  },
  TravelAgencyNotInCorrectState: class extends TravelAgencyUseCaseError {
    constructor() {
      super(...arguments);
      this.code = `${RemoveParticipant.UC_CODE}travelAgencyNotInCorrectState`;
      this.message = "TravelAgency is not in correct state.";
    }
  },
  TripDoesNotExist: class extends TravelAgencyUseCaseError {
    constructor() {
      super(...arguments);
      this.code = `${RemoveParticipant.UC_CODE}tripDoesNotExist`;
      this.message = "Trip does not exist.";
    }
  },

  TripDaoRemoveParticipantFailed: class extends TravelAgencyUseCaseError {
    constructor() {
      super(...arguments);
      this.code = `${RemoveParticipant.UC_CODE}tripDaoRemoveParticipantFailed`;
      this.message = "Add participant in trip failed.";
    }
  },
};
