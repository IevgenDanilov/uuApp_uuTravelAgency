...
class AddParticipantAbl {
  ...
  async addParticipant(awid, dtoIn, uuAppErrorMap = {}) {
    ...
    if (trip.participantIdList && !trip.participantIdList.includes(participantId)) {
      participantIdList = [...trip.participantIdList, participantId];
    } else if (!!trip.participantIdList) {
      participantIdList = [...trip.participantIdList];
    } else participantIdList = [participantId];
